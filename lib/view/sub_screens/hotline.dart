          ...
          child: Stack(
            children: [
                  ...
                  children: [
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: Container(
                          height: isBottomSheetOpen ? screenHeight * 0.45 : screenHeight * 0.7,
                          child: Stack(
                            children: [
                              AbsorbPointer(
                                absorbing: isBottomSheetOpen, 
                                child: GoogleMap(
                    ...
                    InkWell(
                      ...
                      child: Container(
                          height: isBottomSheetOpen ? screenHeight * 0.2 : screenHeight * 0.095,
                          width: screenWidth,
                          decoration: BoxDecoration(
              ...
              AnimatedPositioned(
                ...
                bottom: isBottomSheetOpen ? 0 : -screenHeight * 0.45,
                left: 0,
                right: 0,
                child: Container(
                  width: screenWidth,
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              ...
                                              child: Container(
                                                height: screenHeight * 0.048,
                                                width: screenWidth * 0.3,
                                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), border: Border.all(color: AppColors.borderColor, width: 1)),
                                                child: Row(
                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                  children: [
                                                    Icon(
