              ...
              Text(
                '${widget.titleText} ',
                  style: GoogleFonts.urbanist(
                    ...
                    color: isDarkMode ? AppColors.shadeGreyColor: AppColors.blackColor,
                    letterSpacing: 0.8,
                  )
              ),
              Text(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color:isDarkMode ? Color(0xff414243) : AppColors.borderColor,
                      width: 2,
                    ),
                  ),
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      color: isDarkMode ? AppColors.shadeGreyColor: AppColors.shadeGreyColor,
                      letterSpacing: 0.8,
                    ),
